...
if st.session_state.page == "Dashboard":
    ...
    if not expenses.empty:
        fig = px.pie(expenses, values='amount', names='category', title='Expense Categories')
        st.plotly_chart(fig)
    ...
    if not transactions.empty:
        ...
        fig = go.Figure()
        fig.add_trace(go.Bar(x=monthly_summary.index.astype(str), y=monthly_summary['Income'], name='Income'))
        fig.add_trace(go.Bar(x=monthly_summary.index.astype(str), y=monthly_summary['Expense'], name='Expense'))
